...
stats %>%
  ...
  kable(
    format = "latex", # O "html" dependiendo de tu salida, pero para PDF usa "latex"
    booktabs = TRUE,
  ...
  footnote(
    general = "Fuente: Elaboración propia con datos del Banco Mundial (WDI).",
    general_title = "", 
...
stats_periodos %>%
  kable(
    format = "latex", # Obligatorio para PDF para que collapse_rows funcione bien
    booktabs = TRUE,
...
# Estimación del modelo de Phillips modificado
...
Para ver el codigo completo del taller, puede acceder al siguiente enlace: [Taller 2 - Procesos Estocásticos](https://github.com/Juan-Moreno1/TE-IA2/blob/19e0e2faf88260ff479b8445d8a4c9e45b96926c/taller2TC.qmd)